    ...
    if($('#home').length){
        ...
        $.supersized({
                    ...
                    slides                  :   [           // Slideshow Images
													{
														image 	: './landing/images/slider/super/supersized-1.jpg',
														title 	: '<h1 class="bigTitle">Vendor Attention Call<br /> <small>vendor value slogan</small></h1><a href="/vendor-signup" class="btn sliderBtn" >sign up</a>',
														thumb 	: '',
														url 	: ''
													},

													{
														image 	: './landing/images/slider/super/supersized-2.jpg',
														title 	: '<h1 class="bigTitle">Freelancer Attention Call<br /> <small>freelancer value slogan</small></h1><a href="/freelancer-signup" class="btn sliderBtn" >freelancers join...free</a>',
														thumb 	: '',
														url 	: ''},

													{
														image 	: './landing/images/slider/super/supersized-3.jpg',
														title 	: '<h1 class="bigTitle">Closing statement<br /> <small>closing slogan</small></h1><a href="/vendor-signup" class="btn sliderBtn" >sign up</a>',
														thumb 	: '',
														url 	: ''
													}
												],
