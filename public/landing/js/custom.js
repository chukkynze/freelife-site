...
$(document).ready(function() {   
    ...
    s.src = "landing/js-plugin/jquery-cookie/jquery.cookie.js";
    $("body").append(s);  
...
jQuery(function($){
    ...
    if($('#home').length){
        ...
        $.supersized({
                    ...
                    {image : './landing/images/slider/super/supersized-1.jpg', title : '<h1 class="bigTitle">Sun is shining<br /> <small>the weather is sweet</small></h1><a href="#news" class="btn sliderBtn" >Read more</a>', thumb : '', url : ''},

                    {image : './landing/images/slider/super/supersized-2.jpg', title : '<h1 class="bigTitle">Moon is rising<br /> <small>the night is bitter</small></h1><a href="#works" class="btn sliderBtn" >Check our work</a>', thumb : '', url : ''},
					 
					{image : './landing/images/slider/super/supersized-3.jpg', title : '<h1 class="bigTitle">Groove is in the heart<br /> <small>ahaaanhaan</small></h1><a href="#works" class="btn sliderBtn" >More info</a>', thumb : '', url : ''}
                    ],
