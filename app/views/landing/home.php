...
<!-- Basic Page Needs
  ================================================== -->
  <meta charset="utf-8">
  <title>ALTEA One Page Parallax HTML5, CSS3, responsive, Bootstrap website template</title>
...
<!-- CSS
  ...
  <link rel="stylesheet" type="text/css" href="/landing/js-plugin/pretty-photo/css/prettyPhoto.css" />
  <link type="text/css" rel="stylesheet" href="/landing/js-plugin/isotope/css/style.css">
  <link rel="stylesheet" href="/landing/js-plugin/supersized/css/supersized.css" type="text/css" media="screen" />
  <link rel="stylesheet" href="/landing/js-plugin/supersized/theme/supersized.shutter.css" type="text/css" media="screen" />
  <!-- icon fonts -->
...
<!-- Primary Page Layout 
  ...
  <div id="globalWrapper" class="localscroll">
    ...
    <header id="mainHeader" class="clearfix">
      <div class="container">
        <div class="row">
          <div class="span12"> <a href="index.html" class="brand"><img src="/landing/images/main-logo.png" alt="ALTEA website template"/></a>
    ...
    <section class="slice color4" id="news">
      <div class="container imgHover">
        <div class="row">
          ...
          <article class="span4">
            <section class="imgWrapper"> <img src="/landing/images/news/news1.jpg" alt="alteae template image news" /> </section>
            <div class="media-hover">
              <div class="mask"></div>
              <div class="iconLinks"> <a href="blog-post.html" title="link" target="_blank" class="iconWrapper"><i class="icon-link"></i></a> <a href="/landing/images/news/news1.jpg" class="prettyPhoto iconWrapper" title="Zoom" ><i class="icon-search"></i></a> </div>
            </div>
            <div class="media-list newsList">
              ...
              <article class="span4">
                <section class="imgWrapper"> 
                  <img src="/landing/images/news/news2.jpg" alt="snowflake template image news" /> 
                </section>
                <div class="media-hover">
                  <div class="mask"></div>
                  <div class="iconLinks"> 
                    ...
                    <a href="/landing/images/news/news2.jpg" class="prettyPhoto iconWrapper" title="Zoom" ><i class="icon-search"></i>
                    </a> 
                  </div>
                </div>
                <div class="media-list newsList">
                  ...
                  <article class="span4">
                    <section class="imgWrapper"> <img src="/landing/images/news/news3.jpg" alt="snowflake template image news" /> </section>
                    <div class="media-hover">
                      <div class="mask"></div>
                      <div class="iconLinks"> <a href="blog-post.html" title="link" target="_blank" class="iconWrapper"><i class="icon-link"></i></a> <a href="/landing/images/news/news3.jpg" class="prettyPhoto iconWrapper" title="Zoom" ><i class="icon-search"></i></a> </div>
                    </div>
                    <div class="media-list newsList">
                      <div class="media">
                        <section class="newsDate">
                ...
                <nav class="arrowsNav"> <a href="#services" class="navDown color4"><i class="icon-down-open"></i></a> <a href="#home" class="navUp color1"><i class="icon-up-open"></i></a> </nav>
                ...
                <section class="slice color1">
                  <div class="container">
                    <div class="row">
                      <div class="span4"> <img src="/landing/images/theme-pics/services.png" alt="services"> </div>
                      <div class="span4">
                    ...
                    <nav class="arrowsNav"> 
                      <a href="#paralaxSlice2" class="navDown color1"><i class="icon-down-open"></i></a> 
                      <a href="#news" class="navUp color3"><i class="icon-up-open"></i></a> 
                    </nav>
                    ...
                    <section class="slice color3" id="works">
                      <div class="container clearfix">
                        ...
                        <nav class="arrowsNav"> 
                          <a href="#team" class="navDown color1"><i class="icon-down-open"></i></a> 
                          <a href="#works" class="navUp color4"><i class="icon-up-open"></i></a> 
                        </nav>
                        <div id="paralaxSlice2" data-stellar-background-ratio="0.5">
                              ...
                              <div class="row">
                                ...
                                <div class="span3">
                                  <article class="boxWrapper color1">
                                    <div><img src="/landing/images/team/pic1.jpg" alt=""></div>
                                ...
                                <div class="span3">
                                  <article class="boxWrapper color1">
                                    <div><img src="/landing/images/team/pic2.jpg" alt=""></div>
                                    <div class="boxContent2">
                                ...
                                <div class="span3">
                                  <article class="boxWrapper color1">
                                    <div><img src="/landing/images/team/pic3.jpg" alt=""></div>
                                    <div class="boxContent2">
                                      <h3>Alexander Doe</h3>
                                ...
                                <div class="span3">
                                  <article class="boxWrapper color1">
                                    <div><img src="/landing/images/team/pic4.jpg" alt=""></div>
                                    <div class="boxContent2">
                                    ...
                                    <div class="boxContent"> <a href="mailto:your.email@little-neko.com">p.anderson66@altea.com</a>
                                      <ul class="socialNetwork">
                                        ...
                                        <li>
                                          <a href="#" class="tips" title="" data-original-title="follow me on Twitter"><i class="icon-twitter-bird"></i></a>
                                        </li>
                                        <li>
                                          <a href="#" class="tips" title="" data-original-title="follow me on Google+"><i class="icon-gplus"></i></a>
                                        </li>
                                        <li>
                                          <a href="#" class="tips" title="" data-original-title="follow me on Linkedin"><i class="icon-linkedin"></i>
                                          </a>
                                        </li>
                                        <li>
                          ...
                          <nav class="arrowsNav"> 
                            ...
                            <a href="#works" class="navUp color2"><i class="icon-up-open"></i></a> 
                          </nav>
                          ...
                          <section class="slice color1"  id="contactSlice" >
                            <div class="container">
                              <div class="row mb40">
                                <div class="span12">
                                  <h1>Contact us</h1>
                                      ...
                                      <fieldset class="clearfix securityCheck">
                                        ...
                                        <div class="row">
                                          <div class="span6 pull-left humanCheck">
                                            <label for="verify" class="pull-left"><img src="/landing/js-plugin/neko-contact-ajax-plugin/php/image.php" alt="Image verification"/></label>
...
<!-- End Document 
  ...
  <script type="text/javascript" src="/landing/bootstrap/js/bootstrap-carousel-ie.js"></script>
  <script type="text/javascript" src="/landing/js-plugin/easing/jquery.easing.1.3.js"></script>
  <script type="text/javascript" src="/landing/js-plugin/supersized/js/supersized.3.2.7.min.js"></script>
  <script type="text/javascript" src="/landing/js-plugin/supersized/theme/supersized.shutter.min.js"></script>
  <script type="text/javascript" src="/landing/js-plugin/responsive-nav/responsive-nav.min.js"></script>

  <script type="text/javascript" src="/landing/js-plugin/isotope/jquery.isotope.min.js"></script>
  <script type="text/javascript" src="/landing/js-plugin/neko-contact-ajax-plugin/js/jquery.form.js"></script>
  <script type="text/javascript" src="/landing/js-plugin/neko-contact-ajax-plugin/js/jquery.validate.min.js"></script>
  <script type="text/javascript" src="/landing/js-plugin/pretty-photo/js/jquery.prettyPhoto.js"></script>
  <script type="text/javascript" src="/landing/js-plugin/parallax/js/jquery.scrollTo-1.4.3.1-min.js"></script>
  <script type="text/javascript" src="/landing/js-plugin/parallax/js/jquery.localscroll-1.2.7-min.js"></script>
  <script type="text/javascript" src="/landing/js-plugin/parallax/js/jquery.stellar.min.js"></script>
  <script type="text/javascript" src="/landing/js-plugin/smoothscroll/SmoothScroll.js"></script>
  <!-- Custom  -->
