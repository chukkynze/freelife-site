                                                                ...
                                                                <tr>
                                                                    <td valign="top">
			                                                            <div mc:edit="std_content00">
                                                                            ...
                                                                            <br />
                                                                            It appears that you may be having problems resetting your password with <?php echo $COMPANY_NAME; ?> the verified link we sent you.
                                                                            <br />
                                                                            <br />
                                                                            We detected multiple attempts to reset your password on our site using this email address and the verified email link. If this was not you, we advise that you contact us at <?php echo $CUSTOMER_SERVICE_EMAIL; ?> so we can make sure your account is properly setup and secured.
                                                                            <br />
                                                                            <br />
                                                                            <br />
