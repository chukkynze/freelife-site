                                                        ...
                                                        <tr>
                                                            <td valign="top">
                                                                <div mc:edit="std_content00">
                                                                    <h1 class="h1">We Found Your Signup Verification! </h1>
                                                                    <h2 class="h2">Thank You For Creating a Free Profile with us.</h2>
                                                                    <strong>Getting started:</strong>
                                                                    <br />
                                                                    Now that we've found your verification link, the first thing we need to do is get your profile up and running so that you can begin to use all of the features available to you. Please, click the link below to verify your email address.
                                                                    <br />
                                                                    <br />
                                                                    <a href="<?php echo $VRFY_EML_LINK; ?>" target="_blank">Click here to Verify Your Email Address</a>
                                                                    <br />
                                                                    <br />
                                                                    or copy and paste this url in your browser address bar:
                                                                    <br />
                                                                    <br />
                                                                    <a href="<?php echo $VRFY_EML_LINK; ?>" target="_blank"><?php echo $VRFY_EML_LINK; ?></a>
                                                                    <br />
                                                                    <br />
                                                                    <strong>Note:</strong> Replying to this message won't verify your email address. You must click the above link to complete the email verification process.
                                                                    <br />
                                                                    <br />
                                                                    Also, to ensure delivery of this and future emails, please add <a href="mailto:<?php echo $ADD_THIS_EMAIL; ?>"><?php echo $ADD_THIS_EMAIL; ?></a> to your Address Book or Safe List.
                                                                    <br />
                                                                    <br />
                                                                    ...
                                                                    <br />
                                                                    <br />
                                                                    P.S.: We are truly glad to have you as a member. Hope to see you at <?php echo $COMPANY_SITE; ?> very soon!
                                                                    <br />
                                                                    <br />
                                                                </div>
                                                            </td>
