This is a Notice.
<?php echo $TEXT_BREAK; ?>
Your Profile's Password has been Changed.
<?php echo $TEXT_BREAK; ?>
<?php echo $TEXT_BREAK; ?>
<?php echo $FULL_NAME; ?>,
<?php echo $TEXT_BREAK; ?>
<?php echo $TEXT_BREAK; ?>
Changes have been recently applied to your profile. If this was not you, we advise that you contact us at <?php echo $CUSTOMER_SERVICE_EMAIL; ?> so we can make sure your account is properly setup and secured.
<?php echo $TEXT_BREAK; ?>
<?php echo $TEXT_BREAK; ?>
<?php echo $TEXT_BREAK; ?>
To ensure delivery of this and future emails, please add <?php echo $ADD_THIS_EMAIL; ?> to your Address Book or Safe List.
<?php echo $TEXT_BREAK; ?>
<?php echo $TEXT_BREAK; ?>
