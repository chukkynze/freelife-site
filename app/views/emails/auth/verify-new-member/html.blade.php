                                                        ...
                                                        <tr>
                                                            <td valign="top">
                                                                <div mc:edit="std_content00">
                                                                    ...
                                                                    <h2 class="h2">For Creating a Free Profile with us.</h2>
                                                                    <strong>Getting started:</strong>
                                                                    <br />
                                                                    The first thing we need to do is get your profile up and running so that you can begin to use all of the features available to you. Please, click the link below to verify your email address.
                                                                    <br />
                                                                    <br />
