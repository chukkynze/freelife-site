                                                        ...
                                                        <tr>
                                                            <td valign="top">
                                                                <div mc:edit="std_content00">
                                                                    <h1 class="h1">We All Forget Sometimes.</h1>
                                                                    ...
                                                                    <br />
                                                                    <br />
                                                                    It appears that you may need to change your password to access your <?php echo $COMPANY_SITE; ?> account.
                                                                    <br />
                                                                    <br />
                                                                    ...
                                                                    <br />
                                                                    <br />
                                                                    <a href="<?php echo $VRFY_EML_LINK; ?>" target="_blank">Click here to re-verify Your Email Address</a>
                                                                    <br />
                                                                    <br />
