...
<?php echo $TEXT_BREAK; ?>
<?php echo $TEXT_BREAK; ?>
It appears that you may be having problems logging into <?php echo $COMPANY_SITE; ?>.
<?php echo $TEXT_BREAK; ?>
<?php echo $TEXT_BREAK; ?>
We detected multiple attempts to login to our site using this email address. If this was you, we advise that you use our Forgotten Login Form at [<?php echo $RESET_PWD_LINK; ?>] to reset your password.
<?php echo $TEXT_BREAK; ?>
<?php echo $TEXT_BREAK; ?>
If this was not you, please still use the Forgotten Login Form, but also contact us at <?php echo $CUSTOMER_SERVICE_EMAIL; ?> so we can make sure your account is properly secured.
<?php echo $TEXT_BREAK; ?>
<?php echo $TEXT_BREAK; ?>
<?php echo $TEXT_BREAK; ?>
